...
...           ENDIF
           ...
           UNTIL             (Returnfl = 1)
             ...
             CONTINUE           IF (AllCustFlag = 0 and SortedBy = 2 and (Cust.CustomerID > ToCustomer or Cust.CustomerID < FromCustomer))
...
.
           ...
           continue                  if (ARTRN.Reference = "UnApplied")                   //HR 2019.9.30
.
...
PRINTDTL
              ...
              PRTPAGE           P;*p=368:PrintLineCnt:
                                ...
                                *alignment=*decimal:
                                *p=490:PrintLineCnt,AgingBucket(1):
                                *p=550:PrintLineCnt,AgingBucket(2):
                                *p=610:PrintLineCnt,AgingBucket(3):
                                *p=670:PrintLineCnt,AgingBucket(4):
                                *p=730:PrintLineCnt,AgingBucket(5):
...
EnableSelections
              ...
              IF                (result = 1)
                SETPROP           EFromCustomer,BGCOLOR=$Window
                SETPROP           EToCustomer,BGCOLOR=$Window
                setfocus          EFromCustomer
              ELSE
                SETPROP           EFromCustomer,BGCOLOR=$BtnFace
                SETPROP           EToCustomer,BGCOLOR=$BtnFace
              ENDIF
              RETURN
;==========================================================================================================
OnKeyPress
                   getprop           EFromCustomer,text=DataLine
                   setprop           EToCustomer,text=DataLine
                   return
.=============================================================================
ExitProgram
                RETURN
...
.
              PRTPAGE           P;*Font=HeaderFont:
                                ...
                                *P=407:58,"75 Toledo Street":                       //HR 2019.10.31 was 410
...
...HR 2019.6.28                    *p=365:240,*Line=365:LastRow:
                                *P=248:(LastRow - 20),*Font=DetailFont,"accounting@apccomponents.com":
...
..HR 2019.6.28                                *p=375:260,"Invoice Date":
              ...
              PRTPAGE           P;*Font=DetailFont:
                                *P=110:138,Cust.Name:                               //HR 2019.8.16 Was 040, now 220
                                *P=110:156,AddressLines(1):
                                *P=110:174,AddressLines(2):
                                *P=110:192,AddressLines(3):
                                *P=110:210,AddressLines(4):
                                *P=110:238,AddressLines(5):
                                *PL:
                                *boldon:
