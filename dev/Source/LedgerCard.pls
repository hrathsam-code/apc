...
;
                   ResetVar          BatchChecks.CustomerID
                   move              Cust.CustomerID,BatchChecks.CustomerID
                   lenset            BatchChecks.CustomerID

                   packkey           BatchChecksKY4 from $Entity,BatchChecks.CustomerID,ARTRN.Reference
                   call              RDBatchChecks4
                   call              KSBatchChecks4
                   chop              BatchChecks.CustomerID,BatchChecks.CustomerID
                   if                (ReturnFl =  0 and BatchChecks.CustomerID != Cust.CustomerID and BatchChecks.CheckNo != ARTDet.Reference)
                     packkey           BatchDetailsKY2 from $Entity,BatchChecks.SeqNo
                     call              RDBatchDetails2

                     chop              BatchChecks
                     else
                       clear             BatchDate,BatchNumber
                     endif
