...
.
           LISTINS           VendEDT,EVendAcctNo,EVendName,EVendAddr1,EVendAddr2:
                                    EVendCity,EVendSt,EVendZip:
..                                    EVendGLAcct:
                                    EVendTaxCode,EVendDiscount,EVendAutoPay:
                                    EVendStatus,EVendRating
...
..HR 2017.4.17           PACKKEY           Date8 FROM MM,slash,DD,slash,YY
           ...
           setprop           DTCheckFrom,text=Date8
...
.
           SETPROP           VendEDT,SELECTALL=$SelectAll
.
...
.
             ...
             SETPROP           VendEDT,READONLY=0
             SETPROP           VendEDT,BGCOLOR=$WINDOW
.
...
VendCOLL
             ...
             %ENDIF
.
             SETPROP           VendCOLL,READONLY=0
             SETPROP           VendCOLL,BGCOLOR=$WINDOW
.
...
..HR 2014.4.17           SETPROP           EVendPhone,*Enabled=0
..HR 2014.4.17           SETPROP           EVendPhone,*BackColor=$BTNFACE


           DISABLEITEM       VendCOLL
...
..HR 2014.4.17              SETPROP           EVendPhone,*UseMaskChars=1
              ...
              SQUEEZE           Vendor.Telephone,Vendor.Telephone,"-"          //HR 4/6/2005
...
..HR 7/15/2005             GetProp           CTInq,*ListColumnText(int2,7)=DATE10
              ...
              SETITEM           VInq4InvoiceDate,0,Date10
...
LoadCheckDetails
              ...
              getprop                  DTCheckFrom,text=CheckFrom
              getprop                  DTCheckTo,text=CheckTo

              LVChecks.DeleteAllItems
              SETLPTR           $Entity

              PACKKEY           CheckKY2 FROM $Entity,Vendor.AccountNumber,CheckFrom
              CALL              RDCheck2
              LOOP
                CALL              KSCheck2
              UNTIL             (ReturnFl = 1 or Check.Entity != $Entity or:
                                Check.Vendor != Vendor.AccountNumber or:
                                Check.CheckDate > CheckTo)
