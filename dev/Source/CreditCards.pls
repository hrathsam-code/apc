...
;==========================================================================================================
ItemSelected
                    LVSearchPLB.GetNextItem giving SelectedRow using *Flags=02,*Start=FirstRow
                    if                 (SelectedRow != -1)
                      LVSearchPLB.GetItemText giving $SearchKey using *Index=SelectedRow,*SubItem=0
                      MOVE               "Y",PassedVar
                      DESTROY            WSearch
                    endif
                    RETURN
...
;
                     IF                (RETURNFL = 1)          //WHAT!!! Somebody deleted this record
                       ...
                       setprop            ECVC,text=CreditCards.CVC
...
;
                    ...
                    if                 (ReturnFl = 1)
                      ...
                      IF               (AlertResult = 1)
                        ...
                        LVCreditCards.DeleteItem using *Index=SelectedRow
                        clear          RecordStatus
                        CALL             MAINRESET
                        call           MainValid
                      ENDIF
