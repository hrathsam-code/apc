...
IOSW	 DIM	   1
.
..HR 2019.8.1  APMASTER IFILE         KEYL=6,UNCOMPRESSED
.
...
NCOL	 FORM	   2
.
..HR 2019.8.1                    INCLUDE   APMASTFD.TXT

                    include            Vendor.FD
.
..HR 2019.8.1                    INCLUDE   CUSTMAST.TXT
                    include            Cust.FD
.
BLANK30	 INIT	   "				  "
DISPQTY	 FORM	   5
...
.
..HR 2019.8.1                    INCLUDE   CUSTIO.TXT
.
START	 CALL	   CLRTRAPS
.
	 TRAP	   STDIOERR IF IO
...
..HR 2019.8.1                    OPEN                 APMASTER,"APMASTER.ISI"
...
.
	 MOVE	   "C" TO WHCH
                     MOVE                 VENDIN TO CustKY        //HR 2019.8.1  CUSTKEY
                     call                 RDCust
..HR 2019.8.1                    CALL                 GETCUST
..HR 2019.8.1                    CMATCH               "H",IOSW
..HR 2019.8.1                    GOTO                 DCUST IF EQUAL
                     if                (ReturnFl = 1)
                       BEEP
...
.
DCUST                MOVE                 Cust.Name,NameIn          //HR 2019.8.1CUSTNAME TO NAMEIN
	 DISPLAY   *P61:NROW,NAMEIN
	 GOTO	   CHKDATA
.
VENDOR	 MOVE	   "V" TO WHCH
..HR 2019.8.1                    MOVE                 VENDIN TO ACCKEY
                     move              VendIn,VendorKY
                     call              RDVendor
.
..HR 2019.8.1                     INCLUDE              APMASTRD.TXT
.
                     GOTO                 VNDNG IF (ReturnFl = 1)              //hr 2019.8.1  OVER
                     MOVE                 Vendor.NAME  TO NAMEIN
	 DISPLAY   *P61:NROW,NAMEIN
	 GOTO	   CHKDATA
.
VNDNG	 BEEP
