...
..HR 2019.3.1                MOVE              "760",StubLine2
                ...
                MOVE              "780",StubTotalLine2
                MOVE              "444",StubLine1
                MOVE              "780",StubLine2
                MOVE              "55",ChecKStub               //HR 8/25/2005
                MOVE              "0",CheckLines
...
PrintCheckLayout
              ...
              PrtPage           P;*font=DetailFont:
                                ...
                                *RECT=(StubLine1 + 220):(StubLine1 + 240):15:780:             //Check Stub Footer 1
                                *p=15:(StubLine1 - 40),*Line=15:(StubLine1 + 254):            //Check Lines       1
                                *p=100:(StubLine1 - 40),*Line=100:(StubLine1 + 254):          //Check Lines       1
                                *p=230:(StubLine1 + 220),*Line=230:(StubLine1 + 254):         //Check Lines       1
                                *p=300:(StubLine1 - 40),*Line=300:(StubLine1 + 254):          //Check Lines       1
                                *p=470:(StubLine1 - 40),*Line=470:(StubLine1 + 254):          //Check Lines       1
                                *p=620:(StubLine1 - 40),*Line=620:(StubLine1 + 254):          //Check Lines       1
                                *p=780:(StubLine1 - 40),*Line=780:(StubLine1 + 254):          //Check Lines       1
                                *p=15:(StubLine1 + 254),*lINE=780:(StubLine1 + 254):          //Check Lines       1
                                ...
                                *p=024:(StubLine1 + 222),"Check Date":                        //Check Stub Footer 1
                                *p=122:(StubLine1 + 222),"Check Number":                      //Check Stub Footer 1
                                *p=245:(StubLine1 + 222),"Vendor":                            //Check Stub Footer 1
                                *p=330:(StubLine1 + 222),"Total Invoice Amt.":                //Check Stub Footer 1
                                *p=490:(StubLine1 + 222),"Total Discout Amt.":                //Check Stub Footer 1
                                *p=655:(StubLine1 + 222),"Check Amount":                      //Check Stub Footer 1
...
.
              PrtPage           P;*font=DetailFont:
                                *alignment=*left:
                                *p=509:(CheckStub + 070),PrtCheckDate:
                                *p=090:(CheckStub + 090),AmountString:
                                *p=090:(CheckStub + 135 + SingleLine * 0),Vendor.Name:
                                *p=090:(CheckStub + 135 + SingleLine * 1),AddressLine(1):
                                *p=090:(CheckStub + 135 + SingleLine * 2),AddressLine(2):
                                *p=090:(CheckStub + 135 + SingleLine * 3),AddressLine(3):
                                *p=090:(CheckStub + 135 + SingleLine * 4),AddressLine(4):
                                *p=090:(CheckStub + 135 + SingleLine * 5),AddressLine(5):
                                *alignment=*decimal:
                                *p=750:(CheckStub + 070),CheckRun.CheckAmount:
                                *alignment=*left

PrintCheckLine2
              PrtPage           P;*font=DetailFont:
                                *alignment=*left:
                                *p=033:(StubTotalLine1 + 240),PrtCheckDate:
                                *p=033:(StubTotalLine2 + 240),PrtCheckDate:
                                *p=110:(StubTotalLine1 + 240),CheckNumber:
                                *p=110:(StubTotalLine2 + 240),CheckNumber:
                                *p=245:(StubTotalLine1 + 240),Vendor.AccountNumber:
                                *p=245:(StubTotalLine2 + 240),Vendor.AccountNumber:
                                *alignment=*decimal:
                                *p=445:(StubTotalLine1 + 240),CheckRun.GrossAmount:
                                *p=595:(StubTotalLine1 + 240),CheckRun.DiscAmt:
                                *p=755:(StubTotalLine1 + 240),CheckRun.CheckAmount:
