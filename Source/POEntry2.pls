...
..HR 2020.04.14 OrderDetailArray    record             like OrderHeader(100)

MAIN                PLFORM             POEntry.PLF
DataMenu            PLFORM             DataMenu.PLF
ShipToF             plform             POEntry3.plf
...
..HR 2019.7.24                    CREATE             CompanyLogo=100:349:100:930,"f:\apc\CompanyLogo.jpg"
                    CREATE             CompanyLogo=100:379:100:957,"CompanyLogo3.jpg"
...
MainValid
                   IF                (Status = 0)
                     ...
                     IF                (CharCount > 0)
                       getprop           ECustomerID,text=VendorKY
                       call              RDVendor
....                       call              KPOrderHeader
                       IF               (RETURNFL = 1)
...
.
                     ...
                     if                (LastEditRow = 0)               //We have no Kit Components
                       ...
                       if               (PreviewFlag = 1)
                         ...
                         alert            Plain,"Is this Purchase Order entered correctly?",result,"EVERYHING CORRECT?"
                         return           if (result != 1)
                       endif
                       clear             PreviewFlag

                       CALL              GetOrderHeader
                       transaction       Start,SequenceFLST,POHeaderFLST,PODetailsFLST,ARTrnFLST,VendorFLST,PONotesFLST

                       GetNextSeq        POH
                       move              Sequence.SeqNo,POHeader.SeqMajor
                       move              Sequence.SeqNo,POHeader.Reference
                       CALL              WRTPOHeader
;
...
.                       CALL              MAINRESET               //Reset the objects & fields
                   ...
                   GETCOUNT          ECustomerID
                   IF                (Charcount > 0)
                     getprop           ECustomerID,text=VendorKY   //Read the Primary field ito the Key
...
.
                     MOVE              "0",Status
                     setprop           ECustomerID,text=Vendor.AccountNumber
                     CALL              MainValid
                   else
                     setfocus          ECustomerID
                   ENDIF
...
Dim20               dim                20
                   ...
                   getprop            ESalesRep,text=DIM20
                   squeeze            Dim20,Dim20
                   if                 (Dim20 = "")
                     beep
                     alert              note,"A Buyer must be enetered",result,"INVALID BUYER"
                     move               "1",ValidFlag
                     setfocus           ESalesRep
                     return
                   endif
                   ...
                   for                 X from "1" to (LastEditRow - 1) using "1"
                     ...
                     getprop            NPrice(X),value=OrderPrice
                     MOVE               PODetails.UnitPrice,ExtendedPrice
...
SETMAIN
.                    debug
..                    setprop           ECustomerID,text=Vendor.CustomerID
...
GetOrderHeader
                    ...
                    clear              POHeader
                    call               GetMain
                    move               $Entity,POHeader.Entity
                    CBTerms.GetCurSel  giving result
                    move               TermCodeArray(result),POHeader.TermCode
                    move               TermCodeArray(result),ARTRMKY
                    call               RDARTrm

                    getprop            ESalesRep,text=POHeader.Buyer
                    clock              TimeStamp,POHeader.TransDate
                    getprop            CBCompleted,value=POHeader.Completed
                    clock              TimeStamp,POHeader.BillDate
                    getprop            DTOrderDate,text=POHeader.ShipDate
                    getprop            NTotals,value=POHeader.InvoiceAmt
...                    move               POHeader.InvoiceAmt,POHeader.TotalAmt
                    getprop            NFreight,value=POHeader.Freight
                    subtract           "1",LastEditRow,POHeader.Lines
                    move               "N",POHeader.Printed
                    move               "I",POHeader.InvCredit
                    %endif
...
GETMAIN
                     %if               $EntryProgram = 2
                     getprop           ECustomerID,text=POHeader.BillVendor
                     move              POHeader.BillVendor,POHeader.ShipToVendor

                     getprop           DTOrderDate,text=POHeader.OrderDate
..                     getprop           DTShipDate,Checked=EndDateFlag


                    CBShipmentCode.GetCurSel giving result
                    CBShipmentCode.GetText Giving POHeader.ShipVia using *Index=result

                    getprop            STPONo,text=POHeader.CustomerPO
                    getprop            CBCompleted,value=POHeader.Completed
                    getprop            EWeight,value=POHeader.Weight
                    getprop            ECartons,value=POHeader.Cartons

                    getprop            ECustName,text=POHeader.BillToName
                    getprop            ECustAddr1,text=POHeader.BillToAddress1
                    getprop            ECustAddr2,text=POHeader.BillToAddress2
                    getprop            ECustAddr3,text=POHeader.BillToAddress3

                    getprop            ECustCity,text=POHeader.BillToCity
                    getprop            ECustSt,text=POHeader.BillToSt
                    getprop            ECustZip,text=POHeader.BillToZip
                    getprop            ECustCountry,text=POHeader.BillToCountry
;
; Main Ship-To information
;
                    getprop            STShipName,text=POHeader.ShipToName

                    getprop            STShipAddress1,text=POHeader.ShipToAddress1
                    getprop            STShipAddress2,text=POHeader.ShipToAddress2
                    getprop            STShipAddress3,text=POHeader.ShipToAddress3

                    getprop            STShipCity,text=POHeader.ShipToCity
                    getprop            STShipSt,text=POHeader.ShipToSt
                    getprop            STShipZip,text=POHeader.ShipToZip
                    getprop            STShipCountry,text=POHeader.ShipToCountry
...
;==========================================================================================================
WriteInvoiceDetails
..HR 2020.04.14                    clear              OrderDetailArray
                    for                 X from "1" to (LastEditRow - 1) using "1"
                    call               MoveEntryFieldsToInvoice
                    chop               PODetails.PartNumber,PODetails.PartNumber
                    continue           if (PODetails.PartNumber = "")                              //HR 2019.7.22

                    switch             Status

                    case               1                           //Changed
                      packkey          PODetailsKY from POHeader.Reference,PODetails.LineNo
                      call             TSTPODetails
                      if               (ReturnFl = 1)
                        transaction      Rollback
                        alert            stop,"Error Updating Kit Detail Records",result
...
......                      call               RDParts
                      ...
                      move               POHeader.ShipToVendor,PODetails.ShipToVendor

                      move               POHeader.Reference,PODetails.Reference
                      move               POHeader.SeqMajor,PODetails.SeqMajor
                      move               X,PODetails.SeqMinor

                      move               POHeader.Entity,PODetails.Entity
                      move               POHeader.EntryDate,PODetails.EntryDate
                      move               POHeader.TransDate,PODetails.TransDate
                      move               POHeader.BillDate,PODetails.BillDate
                      move               POHeader.ShipDate,PODetails.ShipDate
                      move               POHeader.BillVendor,PODetails.BillVendor
                      move               POHeader.ShipToVendor,PODetails.ShipToVendor
                      getprop            NExtended(X),value=PODetails.ExtendedAmt
                      move               PODetails.InvoiceAmt,PODetails.TaxableAmt
                      move               PODetails.InvoiceAmt,PODetails.SalesAmt

....                      getprop            EProductGroup(X),text=PODetails.Size
                      getprop            NQuantityOrdered(X),value=PODetails.OrderQty
                      getprop            NQuantityShipped(X),value=PODetails.ShipQty
                      getprop            NQuantityBackOrder(X),value=PODetails.BackOrderQty

                      getprop            NPrice(X),value=PODetails.UnitPrice
                      move               X,PODetails.LineNo
                      getprop            EPartNumber(X),text=PODetails.PartNumber
                      getprop            EUOM(X),text=PODetails.UOM
                      clock              TimeStamp,PODetails.TransDate
...                      move               Parts.Description1,PODetails.Description1
...                      move               Parts.Description2,PODetails.Description2
...                      move               Parts.TaxCode,PODetails.TaxCode
                      clear              PODetails.ReplacementPartNumber
                      getprop            Nextended(X),value=PODetails.ExtendedAmt
...                      move               Parts.AllowFractional,PODetails.AllowFractional
...                      move               Parts.SerialNumbered,PODetails.SerialNumbered
...                      move               Parts.WarrantyIncluded,PODetails.WarrantyIncluded
...                      move               Parts.WarrantyTime,PODetails.WarrantyTime
...                      move               Parts.ServiceLife,PODetails.ServiceLife
...                      move               Parts.Cost,PODetails.Cost
...                      move               Parts.Size,PODetails.Size
...                      move               Parts.LotNumber,PODetails.LotNumber
...                      move               Parts.ItemType,PODetails.ItemType
...
;
                      ...
                      getprop            NQuantityOrdered(LastEditRow),value=PODetails.ORderQty

                      if               (PartsKY = "" and PODetails.OrderQty != 0 )
                        beep
...
.                      packkey            CustomerPartDiscountsKY from Vendor.AccountNumber,Parts.PartNumber
.                    move               "1",ReturnFl
.                      if                 (ReturnFl = 1)
...
;      Setup Change Button and turn on/off appropriate buttons
;
                    display            "Validate Vendor"
                    move               "        ",VendorKY
                    clear              VendorKY
                    getprop            ECustomerID,text=VendorKY
                    call               RDVendor if (VendorKY != "")
                    if                 (ReturnFl = 1)
                      beep
                      clearevents
                      alert              stop,"Invalid Vendor Account Number",result,"INVALID ACCOUNT"
                      setfocus           ECustomerID
                      return
                    else
...
.                    return
                     ...
                     debug
                     search            Vendor.TermCode in TermCodeArray(0) from 99 to CBResult
;
; HR 20200403
;
                     if                (equal)
                       sub               "1",CBResult                         //HR 2020.04.08
                       CBTerms.SetCurSel using *Index=cbresult
                     else
...
;
                    setprop            ECustName,text=Vendor.Name
                    setprop            ECustAddr1,text=Vendor.Address1
                    setprop            ECustAddr2,text=Vendor.Address2
                    setprop            ECustAddr3,text=Vendor.Address3

                    setprop            ECustCity,text=Vendor.City
                    setprop            ECustSt,text=Vendor.State
                    setprop            ECustZip,text=Vendor.Zip
                    setprop            ECustCountry,text=Vendor.Country
;
; Main Ship-To information
;
                    setprop            STShipName,text=Vendor.Name

                    setprop            STShipAddress1,text=Vendor.Address1
                    setprop            STShipAddress2,text=Vendor.Address2
                    setprop            STShipAddress3,text=Vendor.Address3

                    setprop            STShipCity,text=Vendor.City
                    setprop            STShipSt,text=Vendor.State
                    setprop            STShipZip,text=Vendor.Zip

.                    setprop            ETermsCode,text=Vendor.TermCode
.                    candisp            ETermsCode,ARTRM,STermCode,Desc


.                    setprop            EShipToCustAddress2,text=Vendor.Address2
.                    setprop            EShipToCustAddress3,text=Vendor.Address3

.                    setprop            EShipToCustCity,text=Vendor.City
.                    setprop            EShipToCustSt,text=Vendor.St
.                    setprop            EShipToCustZip,text=Vendor.Zip
.                    setprop            ETermsCode,text=Vendor.TermCode

                    call               LoadShipToInfo

                    setprop            ShipCollection,BGColor=$Window,Static=0
...
.                    move               Vendor.CustomerID,ShipCustomerID
.
...
.                      incr               ShipToNum
.                      chop             ShipTo.Address1,ShipTo.Address1
.                      chop             ShipTo.City,ShipTo.City

.                      pack               DataLine from ShipToNum," - ",ShipTo.Address1,", ",ShipTo.City
...
.                      move               Vendor.AccountNumber,ShipCustomerID
.                      pack               ShipToKY from ShipCustomerID,ShipTonum
.                      call               RDShipTo

.                      setprop            STShipName,text=Vendor.Name,static=1,BGColor=$BtnFace

.                      setprop            STShipAddress1,text=Vendor.Address1,static=1,BGColor=$BtnFace
.                      setprop            STShipAddress2,text=Vendor.Address2,static=1,BGColor=$BtnFace
.                      setprop            STShipAddress3,text=Vendor.Address3,static=1,BGColor=$BtnFace

.                      setprop            STShipCity,text=Vendor.City,static=1,BGColor=$BtnFace
.                      setprop            STShipSt,text=Vendor.State,static=1,BGColor=$BtnFace
.                      setprop            STShipZip,text=Vendor.Zip,static=1,BGColor=$BtnFace

.                      if                 (Vendor.Country = "   ")
.                        move               "USA",ShipTo.Country
.                      endif

.                      setprop            STShipCountry,text=Vendor.Country,static=1,BGColor=$BtnFace
.                    else
...
..                SETITEM           RPrintViaPrinter,0,1      //HR 4/20/2005  Select the Printer now
                   ...
                   DEBUG
                PACKKEY           POHeaderKY3 FROM $Entity,"N"
                PACKKEY           POHeaderKY2 FROM $Entity,PrintFromDate

                CALL              RDPOHeader3 if (PrintType = "P")
                CALL              RDPOHeader2 if (PrintType = "R")
                MOVE              "Y",FirstPrint
                MOVE              "0",POHeader.Reference
                MOVE              "0",SortedCounter
                CLEAR             SortedVendor
                CLEAR             SortedInvoice

              LOOP
                CALL              KSPOHeader3 if (PrintType = "P")
                CALL              KSPOHeader2 if (PrintType = "R")
              UNTIL             ((POHeader.Printed = "Y" or ReturnFL = 1) and PrintType = "P")
              UNTIL             ((POHeader.TransDate > PrintToDate or ReturnFL = 1) and PrintType = "R")
..HR 2020.04.15                CONTINUE          IF (PrtInvType = 2 and POHeader.InvCredit != "C")    //Ignore everything except Credit Memos
..HR 2020.04.15                CONTINUE          IF (PrtInvType = 3 and POHeader.InvCredit != "D")    //Ignore everything except Debit Memos
..HR 2020.04.15                CONTINUE          IF (PrtInvType = 4 and POHeader.InvCredit != "I")    //Ignore everything except Debit Memos
                CONTINUE          IF ((POHeader.Reference < PrintFromInvoice or POHeader.Reference > PrintToInvoice) and PrintType = "R")
                CONTINUE          IF (PrintType = "R" and POHeader.Printed != "Y")
.
...
.
                PACKKEY           VendorKY FROM POHeader.BillVendor
                CALL              RDVendor
                CONTINUE          IF (ReturnFL = 1)
                ADD               "1",SortedCounter
                MOVE              Vendor.Name,SortedVendor(SortedCounter)
                MOVE              POHeader.Reference,SortedInvoice(SortedCounter)
                IF                (PrintType = "P")                                      //HR 2019.7.9
                  move              POHeader.Reference,InvoicesToReset(SortedCounter)    //Moved Up from below
                endif
              REPEAT
...
;
              FOR               IndexCounter FROM "1" TO SortedCounter USING "1"
                ...
                PACKKEY           POHeaderKY FROM $Entity,SortedInvoice(IndexCounter)
                CALL              RDPOHeader
                IF                (ReturnFL = 1)
                ...
                MOVE              POHeader.TermCode,ARTRMKY
                CALL              RDARTRM
                MOVE              POHeader.BillVendor,VendorKY
                CALL              RDVendor
...
PrintNewCopyFlag    form               1
                ...
                FOR              CopyNumber FROM "1" TO "1" USING "1"          //3
Harry123
...
; Moed from above  ^^^^^^^
                  ...
                  CONTINUE          IF (POHeader.InvCredit = "C" and CopyNumber != 3)        //HR 5/6/2005 Only print 3rd copy for Credits
                  CONTINUE          IF (POHeader.InvCredit = "D" and CopyNumber != 3)        //HR 4/9/2009 Only print 3rd copy for Credits

...                  CONTINUE          if (Vendor.InvMethod = 4 and CopyNumber != 3)          //Do Not PRINT Option is selected  HR 3/8/2010

                  PACK              DocumentType from "Invoice :",POHeader.Reference
;
...
;
                  if                   (CopyNumber > 1)
                   ...
                   move              Vendor.AccountNumber,Cust.CustomerID
                   move              Vendor.POFax,Cust.Fax
                   move              Vendor.POEmail,Cust.Email
...
..HR 2019.7.9                    MOVE              POHeader.Reference,InvoicesToReset(ResetNumber)
..HR 2019.7.9                  ENDIF

                  MOVE              "860",FormLineNo
                  CALL              PrintPOHeader
                  PACKKEY           PODetailsKY3 FROM POHeader.Entity,POHeader.SeqMajor
                  CALL              RDPODetails3
                  LOOP
                    CALL              KSPODetails3
                  UNTIL             (POHeader.SeqMajor != PODetails.SeqMajor or ReturnFL = 1)
...
.
                  CALC              InvSubtotal = POHeader.InvoiceAmt - POHeader.Freight
                  ...
                  PRTPAGE                   P;*Alignment=*Decimal:
                                            ...
                                            *P=1960:2380:                       //,*Alignment=*Decimal:
                                            POHeader.Freight:
                                            *P=1960:2450,POHeader.InvoiceAmt:
                                            *Alignment=*Left:
                                            *boldoff
                 endif
...
.
              ...
              IF                (PrintType = "P")
                FOR               X FROM "1" TO ResetNumber USING "1"
                  PACKKEY           POHeaderKY FROM $Entity,InvoicesToReset(X)
                  CALL              RDPOHeader
                  CONTINUE          IF (ReturnFL = 1)                            //Record not found
                  CONTINUE          IF (POHeader.Printed = "Y")                   //Already printed
                  MOVE              "Y",POHeader.Printed
                  CALL              UPDPOHeader                                   //Update the Invoice Header record now to 'P'rinted
                REPEAT
              ENDIF
...
..HR 2020.04.14                    clear              OrderDetailArray
                    for                X from "1" to (LastEditRow - 1) using "1"
                      call               MoveEntryFieldsToInvoice
                      chop               PODetails.PartNumber,PODetails.PartNumber                  //HR 2019.8.16
                      debug
                      continue           if (PODetails.PartNumber = "")                              //HR 2019.7.22
...
ShowInvoiceLoadMod routine           Document
                   ...
                   CREATE             CompanyLogo=100:349:100:930,"CompanyLogo.jpg"
.
. When reprinting Invoices/Credits, set it up to print 'everything'
.
                   PACKKEY           POHeaderKY FROM $Entity,Document
                   CALL              RDPOHeader
...
WriteAdditionalLines
                    ...
                    move               PODetails.Entity,PONotes.Entity
                    move               PODetails.SeqMajor,PONotes.SeqMajor
                    move               PODetails.SeqMinor,PONotes.SeqMinor
                    move               EAdditionalLines(X),PONotes.Comments
                    if                 (PreviewFlag = 1)
                    else
                      call               WrtPONotes
                    endif
...
AdditionalLineCount form               3
                    ...
                    if                 (PreviewFlag = 1)
                      ...
                      packkey            PONotesKY from $Entity,PODetails.SeqMajor,PODetails.SeqMinor
                      call               RDPONotes
...
Harry5
                    ...
                    explode            PONotes.Comments,AlertReturn,PrtAdditionalLines
                    loop
                    ...
                    until              (PrtAdditionalLines(AdditionalLineCount) = "")
                      ...
                      PRTPAGE           P;*FONT="HELVETICA(9)":                                     //HR 2019.7.22
                                        ...
                                        *OverLayOn:
                                        *BoldOn:
                                        *V=FormLineNo,*H=220,PrtAdditionalLines(AdditionalLineCount):
                                        *Boldoff:
                                        *OverLayOff
                      ADD               "45",FormLineNo
                    repeat
...
PrintDetailLine
              PRTPAGE           P;*FONT="HELVETICA(9)":                                             //HR 2019.7.22
                                ...
                                *OverLayOn:
                                *boldon:
                                *V=FormLineNo,*H=190,PODetails.OrderQty:
..HR 2020.04.14                                *H=390,PODetails.ShipQty:
..HR 2020.04.14                                *H=590,PODetails.BackOrderQty:
                                *alignment=*left:
                                *BoldOn:
..HR 2020.04.14                                *H=650,PODetails.PartNumber:
                                *H=220,PODetails.PartNumber:
                                *Boldoff:
                                *OverLayOff

PrtExtendedAmt      form               7.2

                    move               PODetails.UnitPrice,PrtExtendedAmt
              ...
              PRTPAGE           P;*FONT="HELVETICA(9)":                                           //HR 2019.7.22
                                ...
                                *V=FormLineNo:
                                *boldon:
                                *H=1608,PrtExtendedAmt,*H=1772,PODetails.UOM:
                                *H=1953,PODetails.ExtendedAmt:
                                *boldoff:
                                *OverLayOff
...
;==========================================================================================================
PrintPOHeader
                    UNPACK            POHeader.ShipDate into CC,YY,MM,DD
                    PACK              ShipDate FROM MM,slash,DD,slash,YY

                    UNPACK            POHeader.BillDate into CC,YY,MM,DD
                    PACK              BillDate FROM MM,slash,DD,slash,YY

                    CHOP              POHeader.ShipVia,POHeader.ShipVia
...
.                    CHOP              POHeader.ShipToCity          //HR 3/29/2005
.                    CHOP              Vendor.City                 //HR 3/29/2005

.                    CHOP              Vendor.Address1
.                    CHOP              Vendor.ShipToAddress2
.                    CHOP              Vendor.ShipToAddress3

.                    ResetVar          AddressLines
.                    MOVE              "1",AddressLineCounter

.                    IF                (Vendor.ShipToAddress1 != "")
.                      MOVE              Vendor.ShipToAddress1,AddressLines(AddressLineCounter)
.                      ADD               "1",AddressLineCounter
.                    ENDIF

.                    IF                (Vendor.ShipToAddress2 != "")
.                      MOVE              Vendor.ShipToAddress2,AddressLines(AddressLineCounter)
.                      ADD               "1",AddressLineCounter
.                    ENDIF

.                    IF                (Vendor.ShipToAddress3 != "")
.                      MOVE              Vendor.ShipToAddress3,AddressLines(AddressLineCounter)
.                      ADD               "1",AddressLineCounter
.                    ENDIF

.                    PACK              AddressLines(AddressLineCounter),Vendor.ShipToCity,", ",Vendor.ShipToState,"  ",Vendor.ShipToZip
.                    ADD               "1",AddressLineCounter
.
.                    IF                (Vendor.ShipToCountry != "USA" and Vendor.ShipToCountry != "   ")  //We're shipping to another Country
.                      MOVE              Vendor.ShipToCountry,CNTRYKY
.                      CALL              RDCntry
.                      IF                (ReturnFl = 1)
...
;
                    DEBUG
                    CHOP              POHeader.ShipToAddress1
                    CHOP              POHeader.ShipToAddress2
                    CHOP              POHeader.ShipToAddress3
                    chop              POHeader.ShipToCountry,POHeader.ShipToCountry

                    ResetVar          ShipToAddressLines
                    MOVE              "1",ShipToAddressLineCounter

                    IF                (POHeader.ShipToAddress1 != "")
                      MOVE              POHeader.ShipToAddress1,ShipToAddressLines(ShipToAddressLineCounter)
                      ADD               "1",ShipToAddressLineCounter
                    ENDIF

                    IF                (POHeader.ShipToAddress2 != "")
                      MOVE              POHeader.ShipToAddress2,ShipToAddressLines(ShipToAddressLineCounter)
                      ADD               "1",ShipToAddressLineCounter
                    ENDIF

                    IF                (POHeader.ShipToAddress3 != "")
                      MOVE              POHeader.ShipToAddress3,ShipToAddressLines(ShipToAddressLineCounter)
                      ADD               "1",ShipToAddressLineCounter
                    ENDIF

                    PACK              ShipToAddressLines(ShipToAddressLineCounter),POHeader.ShipToCity,", ",POHeader.ShipToSt,"  ",POHeader.ShipToZip
                    ADD               "1",ShipToAddressLineCounter

                    IF                (POHeader.ShipToCountry != "USA" and POHeader.ShipToCountry != "")  //We're shipping to another Country
                      MOVE              POHeader.ShipToCountry,CNTRYKY
                      CALL              RDCntry
                      IF                (ReturnFl = 1)
                    ...
                    PRTPAGE           P;*FONT="HELVETICA(9)":
                                      ...
                                      *UNITS=*LOMETRIC:
                                      *PENSIZE=4:
                                      *RECT=55:165:1650:2010:             //Was 80                   //Paper Type (i.e. Invoice, Packing Slip, etc)
                                      *P=1650:110,*LINE=2010:110:
                                      *PENSIZE=1:
//HR 2020.04.16                              *RECT=640:720:1:410:
//HR 2020.04.16                              *RECT=640:720:410:600:         //Customer Order No, Date Shipped, Weight
//HR 2020.04.16                                      *RECT=640:720:600:750:
                                      *OVERLAYON:
                                      *RECT=640:720:1:230:
                                      *RECT=640:720:1:630:
                                      *RECT=640:720:1:940:       //Cartons, Shipped Via, Terms       //HR was 750
                                      *RECT=640:720:940:1340:
                                      *RECT=640:720:1340:2010:    //Order, (Completed/Partial)     Was 1700
                                      *RECT=640:720:1740:2010:
                                      *FGCOLOR=*Black:            //HR 2020.04.16        ,*BGCOLOR=LightGrayRGB:
..HR 2020.04.16                                      *FILL=*ON:
..HR 2020.04.17                              *RECT=55:115:1650:2010:             //Was 80                   //Paper Type (i.e. Invoice, Packing Slip, etc)
                                      *RECT=720:800:1:1470:               //340                      //,*RECT=810:850:340:1190:
                                      *FONT="HELVETICA(7)",*BOLDON:
                                      *FGCOLOR=*Black:             //HR 2020.04.16    ,*BGCOLOR=LightGrayRGB:
                                      *OVERLAYOFF:
                                      *V=725,*H=046,"QUANTITY":                         //,*H=645,"DESCRIPTION":
                                      *v=760:
                                      *H=046,"ORDERED":                                 //,*H=260,"SHIPPED",*h=401,"BACK ORDERED":
                                      *h=300,"D E S C R I P T I O N":
                                      *FILL=*OFF:
                                      *FGCOLOR=*BLACK,*BGCOLOR=*WHITE:
                                      *P=1:720,*LINE=1:2500:
..HR 2020.04.14                                      *P=001:755,*LINE=600:755:
..HR 2020.04.14                                      *P=200:755,*LINE=200:2500:
..HR 2020.04.14                                      *P=400:755,*LINE=400:2500:
..HR 2020.04.14                                      *P=600:720,*LINE=600:2500:
                                      *P=200:720,*LINE=200:2500:
...
...HR 2019.9.4                            *P=110:465,"D",*H=110,*V=530,"T",*H=110,*V=565,"O":
                                      *P=080:360,"V",*H=080,*V=395,"E",*H=080,*V=430,"N":    //REMOVED 4.15.2020, Added Back 4.17.2020
                                      *P=080:465,"D",*H=080,*V=500,"O",*H=080,*V=535,"R":
...
..HR 20200317                                      *V=643,*H=20,"CUSTOMER ORDER NO.",*H=306,"DATE SHIPPED":
                                      *V=643,*H=20,"DATE ORDERED":          //*H=413,"DATE ORDERED":
..HR 2020.04.15                                      *H=606,"WEIGHT",*H=756,"CARTONS":
..HR 20200317                                      *H=806,"SHIPPED VIA",*h=1306,"TERMS",*H=1706,"ORDER":
..HR 2020.04.16                                      *H=906,"SHIP VIA",*h=1306,"TERMS":                      //HR 2020.04.15 ,*H=1706,"ORDER":
                                      *H=233,"BUYER":
                                      *H=636,"SHIP VIA",*h=1346,"TERMS":                      //HR 2020.04.15 ,*H=1706,"ORDER":
                                      *H=946,"FOB":
..                                      *H=1710,"PAGE":
                                      *V=685:
..HR 2020.04.15                                      *h=1750,"COMPLETE",*RECT=685:715:1710:1740:
..HR 2020.04.15                                      *h=1910,"PARTIAL",*RECT=685:715:1870:1900:
                                      *FONT="HELVETICA(8)":
                                      *FGCOLOR=*BLACK:
                                      *BOLDON,*FONT="HELVETICA(10)":
                                      *P=1758:115,POHeader.Reference:
..HR 2020.04.16                                      *BGCOLOR=*YELLOW:
                                      *BOLDOFF:
                                      *BOLDON,*FONT="HELVETICA(10)":
...
.                                      *OverlayOff:                                                //HR 12/8/2005
                                      ...
                                      *FONT="HELVETICA(9)":
                                      *FGCOLOR=*BLACK:           //HR 2020.04.16   *BGCOLOR=*YELLOW,*OVERLAYON:
                                      *FGCOLOR=*BLACK,*BGCOLOR=*WHITE:
                                      *FONT="HELVETICA(9)":
                                      *V=360,*H=170,"ACCT ## ",POHeader.BillVendor:
                                      *V=400,*H=170,Vendor.Name:                           //Was 220, now 190
                                      *V=440,*H=170,ShipToAddressLines(1):
                                      *V=480,*H=170,ShipToAddressLines(2):
                                      *V=520,*H=170,ShipToAddressLines(3):
                                      *V=560,*H=170,ShipToAddressLines(4):
                                      *V=600,*H=170,ShipToAddressLines(5):
                                      *FONT="HELVETICA(9)":
                                      *OverlayOff:                                                //HR 12/8/2005
..HR 2020.04.15                                      *V=300,*H=1440,"ACCT ## ",POHeader.ShipToVendor:
                                      *V=405,*H=1440,"APC COMPONENTS, INC.":           //POHeader.ShipToName:
                                      *V=450,*H=1440,"75 TOLEDO STREET":               //ShipToAddressLines(1):
                                      *V=495,*H=1440,"FARMINGDALE, NY  11735":          //ShipToAddressLines(2):
...                                      *V=495,*H=1440,ShipToAddressLines(3):
...                                      *V=540,*H=1440,ShipToAddressLines(4):
...                                      *V=585,*H=1440,ShipToAddressLines(5):
                                      *P=1480:2510:
..HR 2020.04.15                                      *FONT="HELVETICA(6)":
..HR 2020.04.15                                      "Items not shipped at this time will be backorded and":
..HR 2020.04.15                                      *P=1480:2535,"invoiced at the time of Shipment.  All claims for defective":
..HR 2020.04.15                                      *P=1480:2560,"material, shortages and discrepancies are waived unless ":
..HR 2020.04.15                                      *P=1480:2585,"made in writing within ten days from the date of shipment":
..HR 2020.04.15                                      *P=1480:2610,"Unauthorized returns will not be accepted":
                                  *FONT="HELVETICA(9)",*boldon:
                                  *V=682:
..HR 2020.04.16                                  *H=20,POHeader.CustomerPO:
                                  *H=20,ShipDate:                               //Was 427
..HR 2020.04.15                                  *H=615,POHeader.Weight:
..HR 2020.04.15                                  *H=770,POHeader.Cartons:
..HR 2020.04.16                                  *H=910,POHeader.ShipVia:
                                  *H=236,POHeader.Buyer:
                                  *H=636,POHeader.ShipVia:
                                  *H=950,"SHIPPING POINT":
                                  *H=1350,ARTRM.Desc:
                                  *H=1750,"PAGE:      1":
                                  *boldoff:
                                      *PL;
...
..HR 2020.04.15                    if                 (POHeader.Completed = 1)
..HR 2020.04.15                      PRTPAGE           P;*FONT="HELVETICA(9)":
..HR 2020.04.15                                        *BoldOn:
..HR 2020.04.15                                        *FGCOLOR=*BLACK:
..HR 2020.04.15                                        *P=1712:681,"X":
..HR 2020.04.15                                        *boldOff;
..HR 2020.04.15                    else
..HR 2020.04.15                      PRTPAGE           P;*FONT="HELVETICA(9)":
..HR 2020.04.15                                        *BoldOn:
..HR 2020.04.15                                        *FGCOLOR=*BLACK:
..HR 2020.04.15                                        *P=1872:681,"X":
..HR 2020.04.15                                        *Boldoff;
..HR 2020.04.15                    endif
...
..                                          *RECT=720:800:1470:2010:               //340                      //,*RECT=810:850:340:1190:
                                  ...
                                  *FONT="HELVETICA(9)",*boldon:
                                  *Ulon:
                                  *P=0806:2575,"    ISO-9001:2015   CERTIFIED    ":               // ISO-9001:2015
                                  *ULOff:
                                  *boldoff:
                                                *FONT="HELVETICA(10)";
                    ...
                    prtpage           P;*FONT="HELVETICA(8)",*FGCOLOR=*Black,*BOLDON:
                                      *ulon:
                                      *P=0473:2170,"    CERTIFICATE OF CONFORMANCE REQUIRED    ":
                                      *uloff:
                                      *P=0370:2210,"ALL MATERIALS MUST CONFORM TO THE LATEST REVISIONS":
.                                      *P=920:2350,"P.O. Box 255":
                                      *P=0336:2250,"SHIPMENTS ARE SUBJECT TO OUR INSPECTION AND ACCEPTANCE":
                                      *P=0235:2290,"PLEASE ACKNOWLEDGE RECEIPT AND ACCEPTANCE OF ORDER VIA RETURN EMAIL/FAX":
                                      *P=0579:2330,"purchasing@apccomponents.com":
                                      *P=0250:2440,"BY: __________________________________________________   DATE: ___________":
                                      *boldoff;

..HR 2020.04.14                    prtpage           P;*FONT="HELVETICA(8)",*FGCOLOR=*Black,*BOLDON:
..HR 2020.04.14                                      *P=680:2280,"ALL CORRESPONDENCE AND REMITTANCE TO:":
..HR 2020.04.14                                      *P=840:2320,"APC COMPONENTS INC.":
..HR 2020.04.14                                      *P=920:2350,"P.O. Box 255":
..HR 2020.04.14                                      *P=860:2390,"Farmingdale, NY  11735":
..HR 2020.04.14                                      *P=800:2450,"accounting@apccomponents.com":
..HR 2020.04.14                                      *boldoff;
                    ...
                    prtpage           P;*FONT="HELVETICA(10)",*FGCOLOR=*Black,*BOLDON:
                                      ...
                                      *boldon:
                                  *FONT="HELVETICA(9)",*boldon:
                                  *P=480:2575,"ISO-9001:2015 CERTIFIED":               // ISO-9001:2015
...
PrintCustomHeader
              RETURN
;==========================================================================================================
SortInvoicesByVendor
              FOR                IndexCounter FROM "1" TO (SortedCounter - 1) USING "1"
                FOR                IndexCounter2 FROM "1" TO (SortedCounter - IndexCounter) USING "1"
                  IF                (SortedVendor(IndexCounter2) > SortedVendor(IndexCounter2 + 1))
                    MOVE              SortedVendor(IndexCounter2 + 1),TempInvVendor
                    MOVE              SortedVendor(IndexCounter2),SortedVendor(IndexCounter2 + 1)
                    MOVE              TempInvVendor,SortedVendor(IndexCounter2)
...
.
              ...
              IF                ( ReturnFL = 1 )
..HR 2019.11.11                pack                 dataline from ":",Document,":","  Key:",POHeaderKY
..HR 2019.11.11                alert             note,DataLine,result
                ALERT             stop,"Invoice/Credit does not exist",result
                SETMODE           *MCURSOR=*Arrow
              ELSE
                MOVE              POHeader.TransDate,PrintFromDate              // Set the lowest possible Date
                MOVE              POHeader.TransDate,PrintToDate                // Set the highest possible Date
                CALL              PrintInvoices2                                //
              ENDIF
              RETURN
;==========================================================================================================
...
KeyPressComboBoxShipmentCode
                    ...
                    if                          (result = 13)
                    setfocus           ESalesRep
;NQuantityOrdered(1)   //HR 2020.04.19
                    endif
                    return
;==========================================================================================================
OnKeyPressBuyer
                   EVENTINFO         0,RESULT=result
                   if                          (result = 13)
                     setfocus           NQuantityOrdered(1)   //HR 2020.04.19
                   endif
                   return
;==========================================================================================================
OnKeyPressPO
...
;==========================================================================================================
ShipVia
                   uppercase         POHeader.ShipVia,POHeader.ShipVia
                   scan              "UPS",POHeader.ShipVia
                   if                (equal)
                     beep
...
;==========================================================================================================
LoadUPSRecord
                   move              POHeader.ShipToName,UPSRecord.ShipToName
                   move              POHeader.ShipToAddress1,UPSRecord.ShipToAddress1
                   move              POHeader.ShipToAddress2,UPSRecord.ShipToAddress2
                   move              POHeader.ShipToAddress3,UPSRecord.ShipToAddress3
                   move              POHeader.ShipToCity,UPSRecord.ShipToCity
                   move              POHeader.ShipToSt,UPSRecord.ShipToState
                   move              POHeader.ShipToZip,UPSRecord.ShipToZip
                   move              POHeader.ShipToCountry,UPSRecord.ShipToCountry
                   move              POHeader.Cartons,UPSRecord.Cartons
                   move              POHeader.Weight,UPSRecord.Weight
                   move              POHeader.ShipVia,UPSRecord.ShipVia
.                   move              Vendor.ShippingAcct(2),UPSRecord.ShipToAcctNo
                   move              POHeader.InvoiceAmt,UPSRecord.InvoiceAmount
                   return
;==========================================================================================================
