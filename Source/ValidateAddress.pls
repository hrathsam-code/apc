...
....ResourcePath        init               "/addressvalidation/v1/1?regionalrequestindicator=true&maximumcandidatelistize=10 HTTP/1.0",10,10
...
InputFile           file
                    ...
                    open               Inputfile,"C:\APC\Data\XMLSample.xml",READ
                    read               InputFile,seq;*ABSON,InputStream2
                    pack               InputStream from InputStream2        //,LF,CR,LF,CR
...
OutputFileName      init               "\apc\source\UPSAddress.txt"
.                    replace            ChangeStream,InputStream                 //48
.                    clear              InputStream                                                         *Flags=8,
.                    move               " ",InputStream                      //,*Port=443
...
....                    http               HostName,ResourcePath,*Flags=33,*port=443,*HTTPResult=OutputResults,*result=OutputResults2,*Trace=TraceFileName,*FileName=OutputFileName,*PostMessage=null

.                    InsertXML          OutputFile2,SeqEOF;rs="Request"


.                    InsertXML          OutputFile,SeqEOF;*BLOFF:
.                                                      AddressValidationRequest="Testing"
