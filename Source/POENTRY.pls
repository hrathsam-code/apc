...
.
PONUMBFL           IFILE                name="NextPO",Fix=100
POUser             dim               9
POKEY              dim               17
...
..HR 2019.11.22                    READ                PONUMBFL,APP;DIM8,NEXTPO
                    packkey             POKey from UserCode,APP
                    READ                PONUMBFL,POKey;POUser,DIM8,NEXTPO
	 MOVE	   NEXTPO  TO ADDKEY
	 ADD	   "1"	   TO ADDKEY
	 MOVE	   ADDKEY  TO  NEXTPO
	 REP	   " 0"	IN NEXTPO
                    UPDATE              PONUMBFL;POUser,DIM8,NEXTPO
	 MOVE	   NEXTPO TO PRTPONO
	 DISPLAY   *P52:2,*HON,"PO NUMBER:",PRTPONO,*HOFF
.
                    write                PONumbFL;POUser,NextPO,NextPO,CustName
..HR 2019.11.22                   WRITE               PONUMBFL,NEXTPO;NEXTPO,NEXTPO,CUSTNAME
	 FILEPI	   0
	 RETURN
.
*...........................................................
