...
..HR 2014.4.17              SETPROP           EVendPhone,Text=Vendor.Telephone
...
ViewHistoryByOptions
           ...
           IF (ViewByOption = 2 or ViewByOption = 3)   //Closed Items Only or ALL Transactions
           ...
           UNTIL             (RETURNFL = 1 or (APTRN.Vendor <> Vendor.AccountNumber) or:
                             ...
                             (ViewByOption = 2 and APTRN.TransDate > RangeToDate))

             continue          if (APTRN.DeletedFlag = 1)                  //HR 2019.5.1
             UNPACK            APTRN.TransDate,CC,YY,MM,DD
