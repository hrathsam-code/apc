...
;
                    ...
                    SETPROP           ECustPhone,Text=TelephoneDim15

                    chop              Cust.Fax,Cust.Fax
                    if               (Cust.Fax != "")
                      unpack            Cust.Fax into Phone1,Phone2,Phone3
                      packkey           TelephoneDim15 from Phone1,"-",Phone2,"-",Phone3
                    else
                      move             " ",TelephoneDim15
                    endif
                    SETPROP           ECustFax,Text=TelephoneDim15
...
GETMAIN
                   ...
                   %ENDIF
                    ...
                    gETPROP           ECustPhone,Text=TelephoneDim15
                    squeeze           TelephoneDim15,Cust.Telephone,"-"
                    gETPROP           ECustFax,Text=TelephoneDim15
                    squeeze           TelephoneDim15,Cust.Fax,"-"
