...
Harry1
                    ...
                    IF                (APDist.TransDate < FromDate and APDist.SubEntity != SubEntity and APDist.GLCode = GLMast.Account)
Harry2
...
PrintDetails
                    ...
                    IF                   (PrintDetails = 1)   //Report Details!!!
                      ...
                      PrtPage           P;*alignment=*left:
                                        ...
                                        *p=080:PrintLineCnt,APTrn.Invoice:
...
PrintCustomHeader
              ...
              IF                (PrintDetails = 1)
                PRTPAGE           P;*alignment=*left:
                                  ...
                                  *p=090:PrintLineCnt,"Invoice":
                                  *p=160:PrintLineCnt,"Vendor Name":
                                  *p=425:PrintLineCnt,"Invoice Date":
