...
.
	 ...
	 CALL	   MSSLOPEN
.
STARTUP	 DISPLAY   *ES,*P1:1,"PRINT GULL/NORDEN/SIMMONS	PART LISTINGS":
...
.
	 ...
	 GOTO	   PT1	IF  NOT	 LESS
.
	 ADD	   "100" TO TOTAL
.
PT1	 PRINT	   *30,MSPARTNO,*70,TOTAL
.
	 MOVE	   "0"	TO  TOTAL
	 MOVE	   "0"	TO  SALESCNT
.
...
HEADER	 MOVE	   "4" TO LINES
	 ADD	   "1" TO PAGES
	 PRINT	   *F,*20,COMPNAME,"PARTS SOLD BY AMERICAN PRECISION ":
		   "PRODUCTS	PG ",PAGES,"  ",TODAY
	 PRINT	   " "
	 PRINT	   *30,"PART NUMBER",*68,"QTY ON HAND"
	 PRINT	   " "
	 RETURN
.
