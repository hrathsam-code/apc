...
.
	 ...
	 ENDIF
.
	 DISPLAY	*P=1:02,"Version	  ", OSVER(OSVersion):
...
.
	 ...
	 ENDIF
.
	 DISPLAY	*P=1:10,"Screen	width:	    ",ScrWidth:
			*P=1:11,"Screen	height:	    ",ScrHeight:
...
.
	 ...
	 RETURN
PrtCancel
	 NORETURN      ;Cancel or some other error, skip it.
	 RETURN
*..........................................................................
...
GetFonts     
	 ...
	 ACTIVATE	InfoList, ShowFont, RESULT
...
ShowFont2
	 TRAPCLR	OBJECT
	 FOR		NDX1 FROM "1" TO "16"
	   INSERTITEM	  CharList,999,Char[NDX1]
	 REPEAT
	 ACTIVATE	CharList
	 RETURN
ShowFont9
...
GetTables	
	 ...
	 ACTIVATE	InfoList, TableAction, RESULT
	 SETITEM	InfoList, 0, 1
	 MOVE		"1" TO RESULT
	 CALL		TableAction
	 RETURN
...
TableAction
	 ...
	 COUNT		RESULT FROM TblName
	 SETLPTR	TblName, RESULT
	 DELETEITEM	InfoList1, 0
	 GETINFO	TYPE=DBinfoFile, InfoList1, COLUMNS=TblName
	 ACTIVATE	InfoList1, ColumnAction, RESULT
	 SETITEM	InfoList1, 0, 1
	 MOVE		"1" TO RESULT
	 CALL		ColumnAction
	 RETURN
*..............................................................................
